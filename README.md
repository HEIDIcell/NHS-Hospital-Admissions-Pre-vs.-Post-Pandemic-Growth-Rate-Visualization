...
##🗺️ Visual Mappings
  ...
  ###B. Visual Encoding
    ...
    Size Mapping: The area of each rectangle is proportional to the Average Finished Consultant Episodes in 2020-2021. This allows users to immediately identify the highest-volume services and departments during the pandemic.
